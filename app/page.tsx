      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            >
              לחצו כאן כדי לשלוח מייל ליאיר לפיד שדורשת ממנו לשים את ח״כ יסמין פרידמן הפועלת למען בעלי החיים במקום גבוה ברשימה של מפלגת יש עתיד וכך להבטיח את מקומה בכנסת הבאה
            </button>
          </div>
